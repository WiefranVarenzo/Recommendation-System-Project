# -*- coding: utf-8 -*-
"""Notebook_Model_Recommendation (4).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mUWZJ3ycbmScHUca2dRRNw3aSX84ErV7
...
| Employee ID      | ID karyawan                             | `string`        |
...
| Invoice Total    | Total invoice                           | `float`         |
...
| Telephone       | No telepon pelanggan    | `string`  |
| City            | Kota                    | `string`  |
| Country         | Negara                  | `string`  |
| Gender          | Jenis kelamin (F, M, D) | `category`|
| Date Of Birth   | Tanggal lahir           | `date`    |
| Job Title       | Pekerjaan               | `string`  |
| Age             | Umur                    | `int`     |
...
| -----------------| -----------------------------| ------------- |
| Product ID       | ID unik produk               | `string`      |
| Category         | Kategori utama               | `string`      |
| Sub Category     | Subkategori produk           | `string`      |
| Description PT   | Deskripsi (Portugis)         | `string`      |
| Description DE   | Deskripsi (Jerman)           | `string`      |
| Description FR   | Deskripsi (Perancis)         | `string`      |
| Description ES   | Deskripsi (Spanyol)          | `string`      |
| Description EN   | Deskripsi (Inggris)          | `string`      |
| Description ZH   | Deskripsi (Mandarin)         | `string`      |
| Color            | Warna produk                 | `string`      |
| Sizes            | Ukuran produk                | `list<string>`|
| Production Cost  | Biaya produksi               | `float`       |
...
| Number of Employees| Jumlah karyawan               | `int`     |
| ZIP Code          | Kode pos                       | `string`  |
| City              | Kota                           | `string`  |
| Country           | Negara                         | `string`  |
| Latitude          | Koordinat lintang              | `float`   |
| Longitude         | Koordinat bujur                | `float`   |
| Country_English   | Nama negara dalam bahasa Inggris| `string` |
...
- Sama seperti TF-IDF NearestNeighbors , Precission@K dan Recall@K yang didapatkan cukup baik namun perlu peningkatan. Namun sedikit dibawah TF-IDF NearestNeighbors
...
- Semua model berhasil merekomendasikan produk fashion populer seperti **Coats, Blazers, Jeans, Sportswear, dan Accessories**.
